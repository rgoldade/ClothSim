#ifndef CLOTH_SIM_RENDERER_H
#define CLOTH_SIM_RENDERER_H
...
public:
    ...
    void addTriangles(const VecVec3d& vertices, const VecVec3d& vertexNormals,
...
private:
    ...
    std::vector<VecVec3d> myTriVertexNormals;
